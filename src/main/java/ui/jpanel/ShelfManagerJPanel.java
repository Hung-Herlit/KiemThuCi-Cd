...
import ui.controller.ShelfController;
import util.XDialog;
 ...
 * @author hacke
 */
public class ShelfManagerJPanel extends javax.swing.JPanel implements ShelfController {

    /**
     * Creates new form ShelfManagerPanel
     */
    private boolean check;

    public ShelfManagerJPanel() {
        check = true;
        initComponents();
        this.open();
    ...
    ShelfDAO dao = new ShelfDAOImpl();
    List<Shelf> items = List.of();
    ...
    @Override
    public void edit() {
        Shelf entity = items.get(tblShelf.getSelectedRow());
        this.setForm(entity);
    ...
    @Override
    public void setForm(Shelf entity) {
    ...
    private void initComponents() {
        ...
        btnCheckAll1.setText("Xem dữ liệu ngừng sử dụng");
    ...
    private void HideShow() {
        check = !check;
        this.fillToTable();
        btnCheckAll1.setText(check ? "Xem kệ ngừng sử dụng" : "Ẩn kệ ngừng sử dụng");
    }
